...
import { Waves, MapPin, Phone, Mail, Anchor, Fish, Tent, TreePine, Baby, Shirt, Flame, ChevronLeft } from "lucide-react";
      ...
      <section className="py-24 px-6" style={{ background: "var(--bg-primary)" }}>
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            ...
            <motion.p variants={fadeUp} className="mb-6" style={{ color: "var(--text-muted)" }}>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="mailto:office@serenityresorts.ca" className="btn-outline flex items-center gap-2 justify-center">
